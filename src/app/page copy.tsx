...
<h1 className="text-3xl font-bold mb-6 wow fadeInUp">
        Welcome to WOW.js in Next.js!
      </h1>
      <p className="text-lg wow bounceInLeft">
        This text will animate when you scroll.
      </p>
      <button className="mt-5 p-3 bg-blue-500 text-white rounded wow zoomIn">
        Click Me
      </button>
...
<Navbar expand="lg" className="bg-body-tertiary">
                                ...
                                <div className="row align-items-center justify-between">
                                    <div className="col-lg-6 col-sm-12">
                                        <div className="w-1/2 p-8 text-white b-content">
                                            <h2 className="text-4xl font-bold mb-4 text-white">Proactive Cyber Defence, Powered by Intelligence. Secure Your Future with Adroinnate. 111</h2>
                                            <p className="mb-6 text-white">Adroinnate delivers advanced Managed Security Services, including Next-Gen SOC-as-a-Service, Continuous Threat Exposure Management (CTEM), and Data Security Management, protecting your critical assets from evolving threats.
                                                Leverage our expertise to minimize risk and ensure business continuity.</p>
                                            <a className="white-btn text-decoration-none" href="about.html">
                                                Request a Demo
                                            </a>
                                        </div>
                                    </div>
                                    <div className="col-lg-6 col-sm-12">
                                        <div className="w-1/2">
                                            <img src="./assets/images/hero-2.png" alt="w-full h-full object-cover" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="a-banner-content">
                            <div className="container">
                                <div className="row align-items-center justify-between">
                                    <div className="col-lg-6 col-sm-12">
                                        <div className="w-1/2 p-8 text-white b-content">
                                            <h2 className="text-4xl font-bold mb-4 text-white">Proactive Cyber Defence 111</h2>
                                            <p className="mb-6 text-white">Adroinnate delivers advanced Managed Security Services, including Next-Gen SOC-as-a-Service, Continuous Threat Exposure Management (CTEM), and Data Security Management, protecting your critical assets from evolving threats.
                                                Leverage our expertise to minimize risk and ensure business continuity.</p>
                                            <a className="white-btn text-decoration-none" href="about.html">
                                                Request a Demo
                    ...
                    <div className="row security-box mt-5">
                        <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                            <div className="col-md-12">
                                <Nav variant="pills" className="securitytabs">
                                    <Nav.Item>
                                            ...
                                            <div className="col-md-4">
                                                <div className="service-item wow fadeInUp">
                                                    <div className="icon-box">
                                                        <img src="./assets/images/icons/forensics.png" />
                                                    </div>
      ...
      >
        <h1 className="wow fadeInUp" style={{ fontSize: "32px", fontWeight: "bold" }}>
          Welcome to WOW.js in Next.js!
        </h1>
        <p className="wow fadeInUp" data-wow-delay="0.3s" style={{ fontSize: "18px", color: "#555" }}>
      ...
      {/* Features Section */}
      <section>
        <h2 className="wow fadeInDown" style={{ fontSize: "28px", marginBottom: "20px" }}>
          Features of WOW.js
        </h2>
        <div style={{ display: "flex", justifyContent: "center", gap: "20px", flexWrap: "wrap" }}>
          ...
          >
            <h3 style={{ fontSize: "20px", fontWeight: "bold" }}>Smooth Animations</h3>
            <p style={{ color: "#555" }}>Easily add animations to elements.</p>
          </div>
          <div
          ...
          >
            <h3 style={{ fontSize: "20px", fontWeight: "bold" }}>Lightweight</h3>
            <p style={{ color: "#555" }}>Only loads animations when needed.</p>
          </div>
          <div
          ...
          >
            <h3 style={{ fontSize: "20px", fontWeight: "bold" }}>Customizable</h3>
            <p style={{ color: "#555" }}>Supports different animation delays.</p>
          </div>
        </div>
      </section>
      ...
      >
        <h2 className="wow fadeInUp" style={{ fontSize: "28px" }}>
          Ready to Get Started?
        </h2>
        <p className="wow fadeInUp" data-wow-delay="0.3s" style={{ fontSize: "18px", color: "#ddd" }}>
        ...
        >
          Learn More
                ...
                <div className="container-fluid container-fluid-space">
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="s-title mb-3 text-center">
                    ...
                    <div className="row partner-sub-box">
                        <div className="col-lg-4">
                            ...
                            <a className="default-btn text-decoration-none" href="#">Become a Partner</a>
                        </div>
            ...
            <div className="about-area pb-75">
                <div className="container-fluid container-fluid-space">
                    <div className="s-title full-width-title">
